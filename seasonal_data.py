...
country = 'Unknown'
afgan = [entry[2]for entry in temp1
         if entry[0] == country]
dates = [entry[1]for entry in temp1
         if entry[0] == country]
# print(afgan, dates)
afgan_series = pd.Series(data = afgan, index = dates)
# print(afgan_series)
...
result_mul = seasonal_decompose(afgan_series, model='multiplicative', extrapolate_trend='freq')

# Additive Decomposition
result_add = seasonal_decompose(afgan_series, model='additive', extrapolate_trend='freq')
